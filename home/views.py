...
def contacted_info(request):
    if request.method == "POST":
        ...
        if is_email_exist == True:
            ...
            body = "Name : " + name + "\nEmail : " + email + "\nSubject : " + subject + "\nMessage : " + message
            es.Sender(name + " Contacted You From Resume Builder", "dhobaleprasad3@gmail.com", "contact", body)
            messages.success(request, "Thanks For Contacting " + name + ". We'll Contact You Soon..!!")
        else:
            messages.warning(request, "Entered Email ID is Incorrect")
